...
public class CircularProgress extends View {
    ...
    private void init(Context context) {
        ...
        ringBgWidth = PD_Utility.dp2px(PrathamApplication.getInstance(), 8);
        ringWidth = PD_Utility.dp2px(PrathamApplication.getInstance(), 8);
        gap = PD_Utility.dp2px(PrathamApplication.getInstance(), 125);
        bgGap = PD_Utility.dp2px(PrathamApplication.getInstance(), 0);
    ...
    private void setBgRadius(float value) {
        bgGap = (int) (PD_Utility.dp2px(PrathamApplication.getInstance(), 120) * (1 - value) + .5f);
        invalidate();
    }
    ...
    private void setRadius(float value) {
        gap = (int) (PD_Utility.dp2px(PrathamApplication.getInstance(), 125) * (1 - value) + .5f);
        invalidate();
    }
