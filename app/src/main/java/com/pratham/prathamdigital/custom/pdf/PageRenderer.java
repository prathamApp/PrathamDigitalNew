...
public class PageRenderer implements Renderer {
    ...
    public void updatePageRes(Bitmap lef_res, Bitmap front_res, Bitmap right_res) {
    ...
    public void updateCurlPosition(float value) {
        ...
        switch (active_page) {
            case LEFT:
                leftPage.curlCirclePosition = value;
                break;
            case RIGHT:
                rightPage.curlCirclePosition = value;
                break;
            case CURRENT:
                frontPage.curlCirclePosition = value;
                break;
        }
    }
    ...
    public int getCurrentPagePerc() {
        ...
        switch (active_page) {
            case LEFT:
                return (int) (leftPage.curlCirclePosition / Page.GRID * 100);
            case RIGHT:
                return (int) (rightPage.curlCirclePosition / Page.GRID * 100);
            case CURRENT:
                return (int) (frontPage.curlCirclePosition / Page.GRID * 100);
            default:
                return (int) (frontPage.curlCirclePosition / Page.GRID * 100);
        }
    ...
    public float getCurrentPageValue() {
        ...
        switch (active_page) {
            case LEFT:
                return leftPage.curlCirclePosition;
            case RIGHT:
                return rightPage.curlCirclePosition;
            case CURRENT:
                return frontPage.curlCirclePosition;
            default:
                return frontPage.curlCirclePosition;
        }
