package com.pratham.prathamdigital.custom.persei_dialog;
...
public class PerseiLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeadHeight = t.getInteger(R.styleable.PerseiLayout_menu_height, PD_Utility.dp2px(getContext(), DEFAULT_HEIGHT));
        t.recycle();
    }
