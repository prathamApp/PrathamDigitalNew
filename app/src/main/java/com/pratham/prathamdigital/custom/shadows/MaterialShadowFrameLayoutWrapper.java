package com.pratham.prathamdigital.custom.shadows;
...
import static com.pratham.prathamdigital.util.PD_Constant.DEFAULT_ANIMATE_SHADOW;
import static com.pratham.prathamdigital.util.PD_Constant.DEFAULT_ANIMATION_TIME;
import static com.pratham.prathamdigital.util.PD_Constant.DEFAULT_CALCULATE_ASYNC;
import static com.pratham.prathamdigital.util.PD_Constant.DEFAULT_SHADOW_ALPHA;
import static com.pratham.prathamdigital.util.PD_Constant.DEFAULT_SHOW_WHEN_ALL_READY;
import static com.pratham.prathamdigital.util.PD_Constant.DEFAULT_X_OFFSET;
import static com.pratham.prathamdigital.util.PD_Constant.DEFAULT_Y_OFFSET;
...
public class MaterialShadowFrameLayoutWrapper extends FrameLayout {
    ...
    void initXMLAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            } else if (attr == R.styleable.MaterialShadowFrameLayoutWrapper_manimationDuration) {
