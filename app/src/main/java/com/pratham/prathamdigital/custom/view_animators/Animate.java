...
public class Animate {
    ...
    private Animate(AnimationComposer animationComposer) {
    ...
    public static final class AnimationComposer {
        ...
        private float pivotX = Animate.CENTER_PIVOT, pivotY = Animate.CENTER_PIVOT;
        private Interpolator interpolator;
        private View target;
        ...
        public AnimateString playOn(View target) {
            this.target = target;
            return new AnimateString(new Animate(this).play(), this.target);
        }
    }
    ...
    public static final class AnimateString {
        ...
        private AnimateString(BaseViewAnimator animator, View target) {
            this.target = target;
            this.animator = animator;
        }
    ...
    private BaseViewAnimator play() {
        ...
        if (pivotX == Animate.CENTER_PIVOT) {
            ViewCompat.setPivotX(target, target.getMeasuredWidth() / 2.0f);
        } else {
            target.setPivotX(pivotX);
        }
        if (pivotY == Animate.CENTER_PIVOT) {
