...
import com.pratham.prathamdigital.ftpSettings.server.CmdAPPE;
import com.pratham.prathamdigital.ftpSettings.server.CmdCDUP;
import com.pratham.prathamdigital.ftpSettings.server.CmdCWD;
import com.pratham.prathamdigital.ftpSettings.server.CmdDELE;
import com.pratham.prathamdigital.ftpSettings.server.CmdFEAT;
import com.pratham.prathamdigital.ftpSettings.server.CmdHASH;
import com.pratham.prathamdigital.ftpSettings.server.CmdLIST;
import com.pratham.prathamdigital.ftpSettings.server.CmdMDTM;
import com.pratham.prathamdigital.ftpSettings.server.CmdMFMT;
import com.pratham.prathamdigital.ftpSettings.server.CmdMKD;
import com.pratham.prathamdigital.ftpSettings.server.CmdMLSD;
import com.pratham.prathamdigital.ftpSettings.server.CmdMLST;
import com.pratham.prathamdigital.ftpSettings.server.CmdMap;
import com.pratham.prathamdigital.ftpSettings.server.CmdNLST;
import com.pratham.prathamdigital.ftpSettings.server.CmdNOOP;
import com.pratham.prathamdigital.ftpSettings.server.CmdOPTS;
import com.pratham.prathamdigital.ftpSettings.server.CmdPASS;
import com.pratham.prathamdigital.ftpSettings.server.CmdPASV;
import com.pratham.prathamdigital.ftpSettings.server.CmdPORT;
import com.pratham.prathamdigital.ftpSettings.server.CmdPWD;
import com.pratham.prathamdigital.ftpSettings.server.CmdQUIT;
import com.pratham.prathamdigital.ftpSettings.server.CmdRANG;
import com.pratham.prathamdigital.ftpSettings.server.CmdREST;
import com.pratham.prathamdigital.ftpSettings.server.CmdRETR;
import com.pratham.prathamdigital.ftpSettings.server.CmdRMD;
import com.pratham.prathamdigital.ftpSettings.server.CmdRNFR;
import com.pratham.prathamdigital.ftpSettings.server.CmdRNTO;
import com.pratham.prathamdigital.ftpSettings.server.CmdSITE;
import com.pratham.prathamdigital.ftpSettings.server.CmdSIZE;
import com.pratham.prathamdigital.ftpSettings.server.CmdSTOR;
import com.pratham.prathamdigital.ftpSettings.server.CmdSYST;
import com.pratham.prathamdigital.ftpSettings.server.CmdTYPE;
import com.pratham.prathamdigital.ftpSettings.server.CmdUSER;
import com.pratham.prathamdigital.ftpSettings.server.SessionThread;
...
public abstract class FtpCmd implements Runnable {
    ...
    protected static void dispatchCommand(SessionThread session, String inputString) {
        ...
        com.pratham.prathamdigital.ftpSettings.server.FtpCmd cmdInstance = null;
        verb = verb.trim();
        ...
        for (int i = 0; i < cmdClasses.length; i++) {
            ...
            if (cmdClasses[i].getName().equals(verb)) {
                ...
                Constructor<? extends com.pratham.prathamdigital.ftpSettings.server.FtpCmd> constructor;
                try {
