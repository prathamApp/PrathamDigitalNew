...
import com.pratham.prathamdigital.ftpSettings.MediaUpdater;
import com.pratham.prathamdigital.ftpSettings.utils.FileUtil;
    ...
    public void doStorOrAppe(String param, boolean append) {
        ...
        storing:
        {
            ...
            try {
                if (storeFile.exists()) {
                    if (!append) {
                        if (!FileUtil.deleteFile(storeFile, PrathamApplication.getInstance())) {
                ...
                if (!storeFile.exists()) {
                    FileUtil.mkfile(storeFile, PrathamApplication.getInstance());
                }
                out = FileUtil.getOutputStream(storeFile, PrathamApplication.getInstance());
