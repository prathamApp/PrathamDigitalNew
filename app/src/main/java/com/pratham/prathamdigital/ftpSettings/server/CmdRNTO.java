    ...
    public void run() {
        ...
        mainblock:
        {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
                ...
                if (fromFile.isDirectory()) {
                    FileUtil.renameFolder(fromFile, toFile, PrathamApplication.getInstance());
                } else {
                    FileUtil.moveFile(fromFile, toFile, PrathamApplication.getInstance());
                }
            }
