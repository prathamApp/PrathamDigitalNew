...
import static com.pratham.prathamdigital.util.PD_Utility.getVersion;
...
public class SessionThread extends Thread {
    ...
    public boolean sendViaDataSocket(byte[] bytes, int start, int len) {
        ...
        try {
            ...
            Log.d(TAG, "Couldn't write output stream for data socket, error:" + e.toString());
            return false;
        }
    ...
    public void run() {
        ...
        if (sendWelcomeBanner) {
            writeString("220 SwiFTP " + getVersion() + " ready\r\n");
        }
