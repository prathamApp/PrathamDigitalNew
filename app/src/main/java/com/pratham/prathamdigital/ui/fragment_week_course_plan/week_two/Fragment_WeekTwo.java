package com.pratham.prathamdigital.ui.fragment_week_course_plan.week_two;
...
public class Fragment_WeekTwo extends Fragment implements PlanningContract.weekOnePlanningView {
    ...
    public void init() {
        ...
        planningPresenter.fetchEnrolledCourses("WEEK_2");
    }
    ...
    public void loadEnrolledCourses(List<Model_CourseEnrollment> coursesEnrolled) {
        if (coursesEnrolled != null && !coursesEnrolled.isEmpty()) {
            ...
            if (adapter == null) {
                adapter = new RV_CourseAdapter(getActivity(), Fragment_WeekTwo.this);
    ...
    public void loadCourses(HashMap<String, List<Modal_ContentDetail>> courses) {
        ...
        if (courses != null && !courses.isEmpty()) {
            ...
            if (selectCourseAdapter == null) {
                selectCourseAdapter = new RV_SelectCourseAdapter(getActivity(), courses, Fragment_WeekTwo.this);
                FlexboxLayoutManager flexboxLayoutManager = new FlexboxLayoutManager(getActivity(), FlexDirection.ROW);
                flexboxLayoutManager.setJustifyContent(JustifyContent.CENTER);
    ...
    public void onCourseTimeSelected() {
        ...
        mHandler.sendEmptyMessage(HIDE_DATE_PICKER);
        planningPresenter.addCourseToDb("WEEK_2", selectedCourse, startDate, endDate);
    }
...
//        startSelectionDate.add(Calendar.MONTH, -1);
    ...
    public void openCamera() {
        KotlinPermissions.with(Objects.requireNonNull(getActivity()))
                ...
                .onAccepted(permissionResult -> {
                    ...
                    File image = new File(imagesFolder, FastSave.getInstance().getString(PD_Constant.SESSIONID, "na") + "_WEEK_2.jpg");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST && resultCode == Activity.RESULT_OK) {
            coach_image.setVisibility(View.VISIBLE);
            coach_image.setImageURI(capturedImageUri);
            planningPresenter.markCoursesVerified("WEEK_2",
            ...
            planningPresenter.checkProgress("WEEK_2", data.getStringExtra(PD_Constant.COURSE_ID));
        }
    }

    @Override
    public void deleteCourse(int pos, Model_CourseEnrollment c_enrolled) {
        planningPresenter.deleteCourse(c_enrolled, "WEEK_2");
        ...
        exitDialog = new BlurPopupWindow.Builder(getActivity())
                ...
                .bindClickListener(v -> {
                    ...
                    new Handler().postDelayed(() -> {
                        ...
                        bundle.putString(PD_Constant.WEEK, "WEEK_2");
    ...
    public void showChilds(List<Modal_ContentDetail> childs, String courseId) {
        KotlinPermissions.with(Objects.requireNonNull(getActivity()))
                ...
                .onAccepted(permissionResult -> {
                    ...
                    intent.putExtra(PD_Constant.WEEK, "WEEK_2");
